...
const slides: Slide[] = [
  {
    ...
    items: [
      { icon: <FaShieldHalved />, label: "Anti-Raid", sub: "Live shield" },
      { icon: <FaCircleCheck />, label: "Permission Guard", sub: "Role safety" },
      { icon: <FaTriangleExclamation />, label: "Emergency Lock", sub: "Fast mitigation" },
      { icon: <FaSliders />, label: "Auto Rules", sub: "Adaptive limits" },
    ],
  },
  {
    key: "moderation",
    ...
    items: [
      ...
      { icon: <FaCircleCheck />, label: "Auto Responder", sub: "Trigger replies" },
      { icon: <FaTriangleExclamation />, label: "Spam Filter", sub: "Flood control" },
      { icon: <FaSliders />, label: "Custom Roles", sub: "Role flows" },
    ],
  },
  {
    key: "music",
    ...
    items: [
      ...
      { icon: <FaCircleCheck />, label: "Auto React", sub: "Community fun" },
      { icon: <FaSliders />, label: "Giveaways", sub: "Timed drops" },
    ],
  },
];
