...
export default function Features() {
  ...
  const loopFeatures = [
    ...
    { name: "Emergency", Icon: FaTriangleExclamation },
  ];
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="space-y-6">
              <article className="group/item flex items-start gap-4">
                <span className="grid h-10 w-10 place-content-center rounded-xl bg-amber-400 text-black"><FaShieldHalved /></span>
                <div>
              ...
              <article className="group/item flex items-start gap-4">
                <span className="grid h-10 w-10 place-content-center rounded-xl bg-amber-400 text-black"><FaTriangleExclamation /></span>
                <div>
